...
- **Overnight**: HP heats continuously overnight at model-derived curve. 466-night analysis shows Leather drops 0.8–1.3°C regardless of strategy (HP power-limited). Coasting abandoned. Next optimisation: evening heat banking (22:00 Cosy) + morning DHW coordination. See `docs/heating-plan.md`.
...
- **466-night overnight analysis** (Oct 2024 – Apr 2026): Leather drops 0.8–1.3°C overnight regardless of flow temp or strategy. HP is power-limited. Coasting saves at most 10–20p/night at mild temps, impossible below ~8°C. Effective HTC overnight ~190 W/K (not 261). Pivot to optimal continuous flow temp + evening heat banking + DHW coordination.
- **Empirical τ**: 50h daytime (53 segments), ~30h overnight (lower internal gains). K=7500 in code, empirical K≈20,600 — deprioritised since coasting abandoned.
