...
- **Empirical τ**: 50h from daytime DHW segments (n=53), but **first coast night (4–5 Apr) implied τ≈30h overnight** — model underpredicted cooling by 1.6× (predicted 0.8°C, actual 1.3°C in 4.6h). Likely cause: internal gains drop overnight (~200W sleeping vs 650W daytime). K=7500 in code, empirical K≈20,600 — not yet tested (need colder night with larger Leather dip). See `docs/heating-plan.md` § Empirical vs model parameters.
