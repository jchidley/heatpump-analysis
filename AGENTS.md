...
- **Model vs empirical mismatch**: τ=15h model vs ~45h empirical (DHW segments), K=7500 vs ~20600 empirical. Both errors reinforced "always heat all night". DHW-segment τ may be biased high (short segments, warm surroundings). Each overnight is now an experiment: predicted vs actual. See `docs/heating-plan.md` § Empirical vs model parameters.
