...
- **Empirical τ=50h**: from 18 calibration-night segments + 35 DHW mini-experiments. Both sources agree (median ~50h). Every DHW charge is a mini cooling experiment; every heating restart is a mini reheat experiment. K (reheat rate) = 7500 in code, empirical K≈20,600 from 27 segments — not yet updated, each coast night will validate. See `docs/heating-plan.md` § Empirical vs model parameters.
