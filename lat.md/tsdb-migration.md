...
1. **Remove the remaining Flux/CSV compatibility tail**
...
2. **Retire migration-tail test specs when the code disappears**
...
3. **Finish the Pico eBUS active-sending gap**
...
4. **Keep the timestamp-precision policy explicit**
