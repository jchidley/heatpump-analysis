...
Representative history readers now run against PostgreSQL by default. Any surviving compatibility scaffolding is internal cleanup work tracked in [[tsdb-migration]], not an operator path.
