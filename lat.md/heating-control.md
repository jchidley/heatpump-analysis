...
The headroom signal publishes every 10s and is part of the live control path. Note: the energy-hub headroom value is unreliable during Cosy windows because it projects drain from current SoC without accounting for active grid charging — this doesn't matter because the controller ignores it during Cosy slots.
