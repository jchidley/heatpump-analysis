...
2. **Thermal model** — 13-room thermal network calibrated from Zigbee temperature sensors and shared TSDB data. Includes equilibrium solver, MWT bisection for control, and DHW session analysis. Live analysis reads PostgreSQL/TimescaleDB directly.
...
| reqwest 0.12 | HTTP client for emoncms REST API and Open-Meteo forecast | `Cargo.toml` |
